...
class HealthCareProfile extends Component {
    ...
    onSubmit = async e => {
        e.preventDefault();
        const { firstname, lastname, password, phoneNumber, address, city, state, zipcode, healthcareprovider } = e.target.elements;
        ...
        const person = {
            ...
            healthCareProvider: healthcareprovider.value !== this.state.healthCareProvider ? healthcareprovider.value : undefined
        };
    ...
    render() {
        return (
            <Container className="parlex-back-signup">
                ...
                <h2><FontAwesomeIcon icon={faHeartbeat} size="1x" />  Health Care Profile</h2>
                <Container style={{ width: "85%", margin: "0 auto" }}>
                    <Form onSubmit={this.onSubmit.bind(this)}>
                        ...
                        <Form.Group as={Row} className="signup-row" controlId="contactid">
                            ...
                            <Form.Label column md="2">Provider Name</Form.Label>
                            <Col md={4}> <Form.Control name="healthcareprovider" type="text" defaultValue={this.state.healthCareProvider} /></Col>
                        </Form.Group>
