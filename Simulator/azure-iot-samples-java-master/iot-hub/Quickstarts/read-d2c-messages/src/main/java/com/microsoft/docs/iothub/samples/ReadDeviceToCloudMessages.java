...
public class ReadDeviceToCloudMessages {
  ...
  private static final String EVENT_HUBS_COMPATIBLE_ENDPOINT = "sb://ihsuprodmwhres011dednamespace.servicebus.windows.net/";

  // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
  private static final String EVENT_HUBS_COMPATIBLE_PATH = "iothub-ehub-iot-hub-ch-4501226-9be14a650e";

  // az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
  private static final String IOT_HUB_SAS_KEY = "WzYOxixP1aKAD7G1lm6Btu195ltCCeh0+H9dr6JLrkE=";
