        ...
        return (
            <Navbar expand="xl" bg="light" variant="light" >
                ...
                <Nav className="mr-auto">
                    ...
                    {this.state.isLoggedIn === false ? <Nav.Link href="#features"><b>About Us</b></Nav.Link> : this.state.usergroup === 'Patient' ? <Nav.Link href="/patientprof"><b>Profile</b></Nav.Link> : this.state.usergroup === 'Admin' ? <Nav.Link href="/adminprof"><b>Profile</b></Nav.Link> : ""}
